...
window.addEventListener('load', function () { return functions_1.generateFields(lists_1.b8); });
var button = document.getElementById('chooseStudent');
button.onclick = function () {
    var inter = setInterval(function () { return functions_1.chooseRandomStudent(lists_1.b8); }, 50);
